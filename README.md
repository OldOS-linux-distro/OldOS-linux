...
OldOS to darmowy system operacyjny Linux, stworzony z myślą o starych komputerach. Daj drugie życie swojemu sprzętowi i graj bez kupowania nowego.
...
- **Sieć** — NetworkManager
- **Baza** — Pisany na linux from scratch (LFS)
...
- Strona: [oldos-linux-distro.github.io](https://oldos-linux-distro.github.io/OldOS-linux-distro/)
...
© 2026 OldOS Group · OldOS nie jest powiązany z Apple Inc. ani z funkcją przywracania starszych wersji iOS.
